	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				...
				<h2>Grower</h2>
				<p>for those that works  in  Acers , not Hours</p>
				<br><br>
				<center>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Grower &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:orange">Your product Our market !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Grower Fam<span>----</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9155306672</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:ajha915530@gmail.com" style="color:orange">ajha915530@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:">
				<span style="font-size:20px"><b>About Grower</b></span>
				Grower is e-commerce trading platform for grains...
			</p>
