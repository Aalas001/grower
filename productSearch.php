		...
		<!-- Footer -->
			...
			<div class="footer-center">
				<div>
					...
					<p style="font-size:20px">Brindavan college of engineering<span>dwarika nagar ,BANGLORE</span></p>
				</div>
				<div>
				...
				<div>
					...
					<p style="font-size:20px"><a href="mailto:ajha915530@gmail.com" style="color:white">artistkattawce@gmail.com</a></p>
				</div>
			</div>
			...
			<div class="footer-right">
				<p class="footer-company-about" style="color:white">
					...
					Art Circle is a club established by the students of brindavan College of Engineering, BANGLORE
